...
| :------------------: | :----------------------------------------------------------: | :------------------------: | :----------------------------------------------------------: |
|      UpperBound      | Cerca i valori del campo scelto (**field**) minori della soglia **upper**. |          Numerici          |     {"type":"UpperBound","field":"TextPost","lower":20}      |
| UpperBound and equal | DescrizioneDescrizioneCerca i valori del campo scelto (**field**) minori o uguali della soglia **upper**. |          Numerici          |     {"type":"UpperBoundE","field":"TextPost","lower":20}     |
|      LowerBound      | Cerca i valori del campo scelto maggiori della soglia **lower** nel campo **field**. |          Numerici          |     {"type":"LowerBound","field":"TextPost","upper":100}     |
| LowerBound and equal | Cerca i valori del campo scelto (**field**) maggiori o uguali della soglia **lower**. |          Numerici          |    {"type":"LowerBoundE","field":"TextPost","upper":100}     |
...
|  Included and equal  | Cerca i valori del campo scelto (**fields**) nei valori compresi o uguali tra la soglia **lower** e **upper**. |          Numerici          | {"type":"IncludedE","fields":"numPost","lower":20,"upper":100} |
